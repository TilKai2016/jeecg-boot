package com.aill.sso.oauth.client.service;


import com.aill.sso.oauth.client.TkeyProperties;
import com.aill.sso.oauth.client.pojo.bo.OAuth2AccessToken;
import com.aill.sso.oauth.client.pojo.bo.OkHttpResponse;
import com.aill.sso.oauth.client.pojo.dto.OauthUserProfile;
...
public class TkeyService {
	...
	/**
	 * title: 使用授权码换取Token（授权码模式、客户端模式、密码模式、刷新模式）
	 * @param code 授权码
	 * @return
	 * @author tilkai
	 * @date 2020/2/26
	...
	/**
	 * title: 根据 AccessToken 获取用户信息
	 * @param oauthToken accessToken访问令牌
	 * @return
	 * @author tilkai
	 * @date 2020/2/26
	 */
